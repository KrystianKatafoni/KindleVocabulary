...
import static com.katafoni.kindlevocabulary.vocabulary.transformation.TranformationErrorCodes.KINDLE_DATABASE_FAILURE;
...
class SqliteReader implements DatabaseReader {
    ...
    public Set<KindleWord> readWordsFromKindleDatabase(String databasePath) {
        ...
        try {
            ...
            String message = messageSourceFacade.getMessage(KINDLE_DATABASE_FAILURE.getMessageCode(), databasePath,
                    e.getMessage());
            logger.error(LoggingUtil.getLoggingMessage(KINDLE_DATABASE_FAILURE.getErrorCode(), message));
            throw new InternalFailureException(KINDLE_DATABASE_FAILURE.getErrorCode(),
            ...
            try {
                ...
                String message = messageSourceFacade.getMessage(KINDLE_DATABASE_FAILURE.getMessageCode(),
